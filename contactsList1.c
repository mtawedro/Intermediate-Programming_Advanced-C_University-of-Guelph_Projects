...
/*
        ...
        */
		...
		else if(isalpha(user[0]) != 0)
		{
            ...
            if(Fname[0] == '\0' )
		    {
                ...
                data->last_name_posn = 248 + data->next;
            ...
            else if(Fname[0] != '\0')
            {
                ...
                data->first_name_posn = 248 + data->next;
            ...
            if(Lname[0] == '\0')
            {
               ...
               // LnameExi = 1;
                ...
                if(Fname[0]== '\0')
                {
                    ...
                    data->company_name_posn = 248 + data->next;
       ...
       //error trap
		...
		//printf("%ld\n%ld\n%ld\n%ld\n%ld\n%s\n", data->first_name_posn, data->last_name_posn, data->company_name_posn, data->email_posn, data->next, data->newString);
